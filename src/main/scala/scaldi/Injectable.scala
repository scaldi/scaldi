...
trait Injectable extends Wire {
   ...
   * @param ids identifiers that define requested injection
   * @tparam T class of the injected dependency
   ...
   * @param injector current injector
   * @param tt implicit, already defined in the scope
   * @param ct implicit, already defined in the scope
   * @tparam T class of the injected dependency
   ...
   * @tparam T TypeClass of a class that qualifies as an identifier
...
/**
 * Exactly Injectable trait with all methods made public
 */
 ...
 * @tparam T TypeClass of class in default parameter
 */
